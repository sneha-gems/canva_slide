...
export const nonVegMenQuestion = [
...
export const betterSleepQuestions = [
  ///API URL: 'questions/supplement/sleep'
...
export const energyMoodQuestions = [
...
export const focusMemoryQuestions = [
...
export const reduceStressQuestions = [
...
export const digestionMetabolismQuestions = [
...
export const immunityQuestions = [
