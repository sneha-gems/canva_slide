...
const vegMaleQuestions = "vegMenQuestions";
const nVegMaleQuestion = "nonVegMenQuestion";
const vegFemaleQuestions = "vegWomenQuestions";
const nVegFemaleQuestion = "nVegWomenQuestions";

const digestionMetabolism = "questions/supplement/digestion-metabolism";
const energyMood = "questions/supplement/energy-mood";
const fitness = "questions/supplement/fitness";
const focusMemory = "questions/supplement/focus-memory";
const immunity = "questions/supplement/immunity";
const reduceStress = "questions/supplement/reduce-stress";
const sleep = "questions/supplement/sleep";

export const matchOptions = (option, initialValues) => {
  // console.log(option, "===========options");
  const gender = initialValues[0].answers[0];

  switch (gender) {
    case "Male":
      switch (option) {
        case "Vegetarian":
          return vegMaleQuestions;
        case "None":
          return nVegMaleQuestion;
        default:
          break;
      }
    ...
    case "Female":
      switch (option) {
        case "Vegetarian":
          return vegFemaleQuestions;
        case "None":
          return nVegFemaleQuestion;
        default:
          break;
      }
...
export const matchSupplements = (option) => {
  switch (option) {
    case "Reduce Stress":
      return reduceStress;
    case "Elevate Fitness":
      return fitness;
    case "Boost Immunity":
      return immunity;
    case "Better Sleep":
      return sleep;
    case "Sharpen Focus + Memory":
      return focusMemory;
    case "Improve Energy + Mood":
      return energyMood;
    case "Improve Digestion + Metabolism":
      return digestionMetabolism;
    default:
      break;
  }
};
